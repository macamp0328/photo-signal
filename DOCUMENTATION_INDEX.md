...
- **[scripts/update-recognition-data.js](./scripts/update-recognition-data.js)** - Unified CLI that refreshes dHash/pHash variants and ORB payloads, keeping `assets/test-data` and `public/data.json` in sync (`npm run update-recognition-data`)
