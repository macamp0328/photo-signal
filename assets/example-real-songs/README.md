...
`<track-number>-<slug>-clip-0X.mp3`.

| Base Recording   | Duration | Clip Files                             | Start Offsets (s) | Default Test Data Mapping |
| ---------------- | -------- | -------------------------------------- | ----------------- | ------------------------- |
| Mass Romantic    | 4m 04s   | `01-mass-romantic-clip-0{1..4}.mp3`    | 0, 60, 120, 180   | Concert ID 8 (R0043343)   |
| Ocelot           | 9m 32s   | `06-ocelot-clip-0{1..4}.mp3`           | 0, 150, 300, 450  | Concert ID 9 (R0055333)   |
| 1999             | 14m 38s  | `13-1999-clip-0{1..4}.mp3`             | 0, 180, 360, 540  | Concert ID 10 (R0055917)  |
| You Enjoy Myself | 24m 01s  | `16-you-enjoy-myself-clip-0{1..4}.mp3` | 0, 300, 600, 900  | Concert ID 11 (R0060632)  |
| Meatstick        | 10m 00s  | `18-meatstick-clip-0{1..4}.mp3`        | 0, 150, 300, 450  | Concert ID 12 (R0060861)  |
| Possum           | 10m 50s  | `20-possum-clip-0{1..4}.mp3`           | 0, 150, 330, 510  | Concert ID 7 (Monochrome) |
...
ffmpeg -hide_banner -loglevel error -ss 150 -t 30 -i "18 Meatstick.mp3" \
  -c:a libmp3lame -b:a 128k -ar 44100 assets/example-real-songs/18-meatstick-clip-02.mp3
```
