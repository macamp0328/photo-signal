...
describe('Hamming Distance', () => {
  describe('hammingDistance', () => {
    ...
    it('should calculate distance for realistic hashes', () => {
      ...
      const hash1 = 'a5b3c7d9e1f20486';
      const hash2 = 'a5b3c7d9e1f20487';
    ...
    it('should handle alternating patterns', () => {
      const hash1 = 'aaaaaaaaaaaaaaaa'; // 1010...
      const hash2 = '5555555555555555'; // 0101...
    ...
    it('should calculate reasonable distances for slightly different images', () => {
      ...
      const hash1 = 'a5b3c7d9e1f20486';
      const hash2 = 'a5b3c7d9e1f20496'; // Changed one hex digit
